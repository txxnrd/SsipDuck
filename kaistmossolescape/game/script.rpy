...
label scene3:
    ...
    n "안녕하세요, 제 이름은 나경입니다. 앞으로 한 주 동안 잘 부탁드려요."
    ...
    "이렇게 첫 분반 회의가 시작되었다. 그들과 함께 하는 동안 어떤 일들이 일어날지는 아직 아무도 모른다. 하지만 한 주 동안의 몰입캠프가 우리 모두에게 좋은 추억을 선사하기를 기대한다"
...
label scene4:   # 첫날, 강의실 안. 
    ...
    label scene4_1:
        ...
        menu:
            p "(실력이 정말 아쉽다..내 여자친구 상대가 되기로는 부족해라고 생각을 한다.) \n 당연하지…너 컴공 다니면서 여태껏 뭐햇어 너 학점 1점대야?":
                jump .scene4_1_a
            #결과: 일주일동안 토라져서 말안하기( 오늘 저녁 같이 못먹음)
            p "내가 천천히 설명 해줄게. 리사이클러 뷰는 어쩌구 저쩌구~":
                jump .scene4_1_b
